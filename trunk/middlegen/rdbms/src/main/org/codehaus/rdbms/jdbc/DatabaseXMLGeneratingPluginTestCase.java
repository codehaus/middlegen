...
public abstract class DatabaseXMLGeneratingPluginTestCase extends AbstractXMLGeneratingPluginTestCase {
    ...
    protected void setUp() throws Exception {
        MutablePicoContainer pluginContainer = new DefaultPicoContainer();
        PicoTableFactory picoTableFactory = new PicoTableFactory(pluginContainer);
        ...
        super.setUp();
        pluginContainer.registerComponentInstance(plugin);
    ...
    private SchemaFactory createSchemaFactory() {
        ...
        connectionFactory.setUsername(getProperty("middlegen.database.userid"));
