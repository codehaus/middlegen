...
public class JDBCSchemaFactory implements SchemaFactory {
    ...
    public Collection makeTables(TableFactory tableFactory, ColumnFactory columnFactory) throws DatabaseException {
                ...
                while (tableRs.next()) {
                    ...
                    if (table == null) {
                        ...
                        if ("TABLE".equals(tableType)) {
                            ...
                            table = tableFactory.createTable(tableRs.getString("TABLE_NAME"));
                        }
                    }
